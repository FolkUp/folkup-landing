...
const descMap: Record<RouteKind, Record<string, string>> = {
  ...
  services: {
    en: 'Directions on long timelines. Translations, OSINT, long-form essays, encyclopedias, illustration, websites. Russian version ready, English translation in progress.',
    ...
    pt: 'Direções em prazos longos. Traduções, OSINT, ensaios longos, enciclopédias, ilustração, sites. Versão em russo disponível, tradução em português em curso.',
    de: 'Richtungen auf langen Fristen. Übersetzungen, OSINT, lange Essays, Enzyklopädien, Illustration, Websites. Russische Version fertig, englische Übersetzung in Arbeit.',
  },
  team: {
...
useHead({
  ...
  meta: () => [
    ...
    { property: 'og:image', content: `${HOST}/images/og-folkup-path-b.webp?v=3` },
