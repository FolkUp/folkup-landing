      ...
      items: [
        {
          ...
          // PT + RU: hero-tier canonical BUNDLE §1/§2 per Iskra visa S311-16 §7 (2026-08-31 21:35 UTC)
          // «Если из BUNDLE что-то не вошло в PR #47 — S1UMBR cont+10 интегрирует, виза дана этим файлом».
          // PT = Iskra S311-07 §3 verbatim ratified; RU = Zeka FolkUp brand voice (Науменко + Кэрролл + фонит).
          // EN + DE preserved as short summary — awaiting Lelik (S1LOLIK) + Bolik (S17BOLIK) native refinement per BUNDLE §3/§4 note.
          text: {
            ...
            ru: 'Книга 1 «Agile Sapiens» теперь по-португальски — версия 1.0.0 стабильная. Перевод и редакторская вычитка завершены: первая книга серии FolkUp — «Agile Sapiens: Литературный анализ управления. Как литература предсказала современный менеджмент» — доступна на европейском португальском, стабильным изданием. Одиннадцать глав, идущих через Верна, Франкенштейна, Шерлока Холмса, Борхеса, Немо, Мину Харкер, доктора Джекилла, Дон Кихота, Машину Времени, НИИЧАВО братьев Стругацких и «Чуму» Камю — чтобы показать: принципы современного управления описаны литературой задолго до того, как получили имена. Каждая глава открывается литературной сценой, проходит через 3-5 задокументированных корпоративных кейсов и закрывается вопросом, остающимся с читателем. Перевод: Zeka, регистр европейского португальского вдохновлён Софией де Мелло Брейнер, Сарамагу, Эсой де Кейрошем и Пессоа. Орфография AO1990. Редакторская вычитка: Iskra (стандарты Priberam · Infopédia · Академии наук Лиссабона · Ciberdúvidas). Аппарат полный: колофон, методология, источники, прозрачность об использовании ИИ, благодарности, предметный указатель. Раскрытие о ИИ согласно Регламенту (ЕС) 2024/1689, статье 50, пункт 4. Автор: Команданте FolkUp. Лицензия: CC BY-SA 4.0. Книга 1 трилогии «Своими средствами» (Pelos Nossos Meios).',
            pt: 'Livro 1 «Agile Sapiens» já em português — v1.0.0 estável. A tradução e a revisão editorial estão concluídas: o primeiro livro da série FolkUp — «Agile Sapiens: Análise Literária da Gestão. Como a Literatura Previu a Gestão Moderna» — está disponível em português europeu, em edição estável. Onze capítulos que atravessam Verne, Frankenstein, Sherlock Holmes, Borges, Nemo, Mina Harker, Doutor Jekyll, Dom Quixote, a Máquina do Tempo, o NIICHAVO dos irmãos Strugatski e «A Peste» de Camus — para mostrar que os princípios da gestão moderna foram descritos pela literatura muito antes de terem nome. Cada capítulo abre com uma cena literária, atravessa três a cinco casos empresariais documentados e fecha com uma pergunta que fica com o leitor. Tradução: Zeka, registo de português europeu inspirado em Sophia de Mello Breyner, Saramago, Eça de Queirós e Pessoa. Ortografia AO1990. Revisão editorial: Iskra (padrões Priberam · Infopédia · Academia das Ciências de Lisboa · Ciberdúvidas). Aparato completo: colofão, metodologia, fontes, transparência sobre IA, agradecimentos, índice remissivo. Divulgação sobre IA conforme o Regulamento (UE) 2024/1689, artigo 50.º, n.º 4. Autor: Comandante FolkUp. Licença: CC BY-SA 4.0. Livro 1 da trilogia «Pelos Nossos Meios».',
