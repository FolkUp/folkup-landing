  ...
  sections: [
    // ----------------------------------------------------------------- HERO
    {
      ...
      tagline: {
        ...
        de: 'FolkUp ist eine kleine Werkstatt — eine Person und ein Team von KI-Assistenten. Wir machen Enzyklopädien, eine Buchreihe und langsame Recherchen. Jeder Fakt durch Quellen. Frei, ohne Registrierung, ohne Werbung.',
      },
    ...
    // ------------------------------------------------------------- SERVICES
    {
      ...
      type: 'services',
      schemaType: 'none',
      label: { en: 'Commissions', ru: 'Комиссии', pt: 'Encomendas', de: 'Aufträge' },
      ...
      body: {
        ...
        de: 'Enzyklopädien zu Ihrem Thema, Bücher, lange Recherchen, lange Essays, Übersetzungen, Illustrationen, Websites. Ein Autor und ein Team von KI-Assistenten. Typischer Zyklus — ab drei Monaten. Nicht für dringende Arbeit, nicht für Inhalte, die auf fremde Algorithmen zugeschnitten sind. <a href="/de/services">Mehr →</a> Schreiben Sie an: info@folkup.app',
      },
    },
