  ...
  sections: [
    ...
    // ------------------------------------------------------------- SERVICES
    {
      ...
      body: {
        ...
        pt: 'Enciclopédias sobre o seu tema, livros, investigações longas, ensaios longos, traduções, ilustrações, sítios web. Um autor com uma equipa de assistentes de IA. Ciclo típico — a partir de três meses. Não para trabalho urgente, nem para conteúdos desenhados para o algoritmo alheio. <a href="/pt/services">Mais →</a> Escreva: info@folkup.app',
        // T-315-12 DE P1 (Bolik S16BOLIK cont+21 EXT 2026-09-07): mirror translation Iskra S315-14 §2
        // canon RU body verbatim — mandatory подводка + 4 commission items с live sample links
