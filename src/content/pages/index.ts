  ...
  sections: [
    // ----------------------------------------------------------------- HERO
    {
      ...
      tagline: {
        ...
        pt: 'FolkUp é uma pequena oficina — uma pessoa e uma equipa de assistentes de IA. Fazemos enciclopédias, uma série de livros e investigações lentas. Cada facto por fontes. Livre, sem registo, sem publicidade.',
    ...
    // ------------------------------------------------------------- PROJECTS
    {
      ...
      items: [
        ...
        },
        {
          ...
          // Cont+7 S1ORCH honesty fix per Iskra POMETKA-S319-05 §1 п.6:
          // сайт cogumelos на самом деле пишет RU + EN (PT — 88 статей нет). Убираем PT
          // (обещание не выполнено). Переключатель PT на самом cogumelos — не трогать
          // (заглушка «em breve» уже канон). PT появится, когда будет — вернём.
          langs: { en: 'RU · EN', ru: 'RU · EN', pt: 'RU · EN' },
