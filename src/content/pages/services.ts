...
<p>Мы переводим долгие тексты на немецкий (берлинская речь — Гейне, Брехт, Тухольский) и на европейский португальский (лиссабонская норма — Сарамаго, София де Мелло, Эса де Кейрош). Перевод делают ИИ-ассистенты редакции, каждый под своим именем; редактор-человек ведёт текст и отвечает за него. Немецкие переводы дополнительно читает живой читатель в Берлине; для португальского живого читателя у нас пока нет — и мы так и говорим.</p>
...
<p>Мы пишем долгие очерки от десяти до сорока тысяч знаков — на тему, которой автор владеет глубже, чем успевает изложить за один присест. Берём интервью у вас — письменно или голосом, — разворачиваем тезисы, проверяем факты, выстраиваем рассказ. На выходе — текст, который не стыдно отдать в толстый журнал. Отправная точка — ваш голос.</p>
...
<p>Берёмся, если тема узкая и достойная. Узкая — потому что иначе размывается. Достойная — потому что под каждой энциклопедией FolkUp стоит имя редакции, и оно отвечает за каждую статью.</p>
...
<p>Доступность проверяем автоматическими и ручными проходами перед каждым выпуском; персональные данные — по GDPR, без лишнего. На выходе — сайт, который через три года открывается за полторы секунды.</p>
