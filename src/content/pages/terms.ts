...
<h2>Contact</h2>
<p>For questions: <a href="mailto:editor@folkup.app">editor@folkup.app</a></p>`,
...
<h2>Контакты</h2>
<p>По вопросам: <a href="mailto:editor@folkup.app">editor@folkup.app</a></p>`,
        pt: `<h2>Aceitação</h2>
...
<h2>Contacto</h2>
<p>Para questões: <a href="mailto:editor@folkup.app">editor@folkup.app</a></p>`,
      },
    },
  ],
}
